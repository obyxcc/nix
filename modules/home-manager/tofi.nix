{pkgs, ...}: {
  xdg.configFile."tofi/config".text = ''
    ...
    #
	    ...
	    placeholder-color = #313244
	    placeholder-background = #00000000
	    placeholder-background-padding = 32
